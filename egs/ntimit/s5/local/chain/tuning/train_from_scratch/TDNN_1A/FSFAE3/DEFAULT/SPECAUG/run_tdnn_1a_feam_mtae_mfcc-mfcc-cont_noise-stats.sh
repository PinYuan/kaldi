...
remove_egs=false
num_of_epoch=70
frame_weight_dae=0.09
frame_weight_dspae=0.09
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/SPECAUG/tdnn_1a_feam_mtae_mfcc-mfcc-cont_noise-stats/${argu_desc}
train_data_dir=data/${train_set}_sp_hires
train_ivector_dir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires
lores_train_data_dir=data/${train_set}_sp

target_scp_dae=data/${train_set}_sp_hires/feats.target.scp
...
if [ $stage -le 12 ]; then
  ...
  stats-layer name=stats-dspae config=mean(-100:1:1:100) input=prefinal-dspae

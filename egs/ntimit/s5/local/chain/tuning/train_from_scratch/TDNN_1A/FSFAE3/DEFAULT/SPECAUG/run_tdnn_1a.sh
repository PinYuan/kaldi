...
if $use_ihm_ali; then
  ...
  dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/SPECAUG/tdnn_${affix}_sp_ihmali/${argu_desc}
  ...
  dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/SPECAUG/tdnn_${affix}_sp/${argu_desc}

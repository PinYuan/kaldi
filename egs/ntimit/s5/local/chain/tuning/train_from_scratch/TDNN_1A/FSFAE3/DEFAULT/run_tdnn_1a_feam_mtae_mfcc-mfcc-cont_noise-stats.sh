...
remove_egs=false
num_of_epoch=40
frame_weight_dae=0.01
frame_weight_dspae=0.01
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mtae_mfcc-mfcc-cont_noise-stats/${argu_desc}

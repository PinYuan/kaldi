...
def get_args():
    ...
    parser.add_argument("--feat-dir", type=str, required=True,
                        ...
                        "the neural network.")
    parser.add_argument("--clean-feat-dir", type=str, required=True,
                        help="Directory with clean features used for training DcAE.")
...
def train(args, run_opts):
    ...
    if ((args.stage <= -3) and args.egs_dir is None):
        ...
        common_lib.execute_command(
            """local/chain/get_egs_dcae.sh {egs_opts} \
                --cmd "{command}" \
                --cmvn-opts "{cmvn_opts}" \
                ...
                {data_dir} {dir} {lat_dir} {target_scp} {clean_target_scp} {egs_dir}""".format(
                ...
                srand=args.srand,
                data_dir=args.feat_dir, dir=args.dir, lat_dir=args.lat_dir, target_scp=args.feat_dir+"/feats.scp", clean_target_scp=args.clean_feat_dir+"/feats.scp", egs_dir=default_egs_dir))

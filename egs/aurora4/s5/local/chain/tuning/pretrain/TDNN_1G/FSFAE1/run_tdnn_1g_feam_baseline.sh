...
dir=exp/chain${nnet3_affix}/pretrain/TDNN_1G/FSFAE1/tdnn_${affix}_feam_baseline/${argu_desc}
...
if [ $stage -le 16 ]; then
  ...
  cp "my_local/add_config/TDNN_1G/baseline/add.config" "$dir/configs/add.config"

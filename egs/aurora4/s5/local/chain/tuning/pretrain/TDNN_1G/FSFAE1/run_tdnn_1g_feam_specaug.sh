...
dir=exp/chain${nnet3_affix}/pretrain/TDNN_1G/FSFAE1/tdnn_${affix}_feam_specaug/${argu_desc}
...
if [ $stage -le 16 ]; then
  ...
  pretrained_mdl="/mnt/HDD2/user_pinyuanc/kaldi/egs/aurora4/s5/exp/nnet3/denoising_autoencoder/aspire_v5/e50_il0.01_fl0.001/final.raw"

...
dir=exp/chain${nnet3_affix}/upper_bound/tdnn_1a_clean_noise/${argu_desc}
train_data_dir=my_data/clean_noise_noisy/${train_set}_sp_hires
    ...
    (
      ...
      for lmtype in tgpr_5k bg; do
        steps/nnet3/decode.sh \
          ...
          $tree_dir/graph_${lmtype} my_data/clean_noise_noisy/${data}_hires ${dir}/decode_${lmtype}_${data_affix} || exit 1
      done

...
argu_desc="e${num_of_epoch}_f${frame_weight}_il${initial_effective_lrate}_fl${final_effective_lrate}_tdnnf7.noop"
...
target_scp=exp/nnet3/ppg/train_si84_clean_sp_hires/tdnnf7.noop/target.scp
...
if [ $stage -le 12 ]; then
  ...
  output name=output_ae input=tdnnf7 objective-type=quadratic
EOF

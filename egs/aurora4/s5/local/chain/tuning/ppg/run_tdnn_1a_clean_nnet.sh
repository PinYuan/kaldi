...
dir=exp/chain${nnet3_affix}/ppg/tdnn_${affix}_clean_nnet/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  output-layer name=output dim=$num_targets $output_opts
EOF
    ...
    (
      ...
      for lmtype in tgpr_5k; do
        steps/nnet3/decode.sh \
          ...
          $gmm_dir/graph_${lmtype} data/${data}_hires ${dir}/decode_${lmtype}_${data_affix} || exit 1
      done

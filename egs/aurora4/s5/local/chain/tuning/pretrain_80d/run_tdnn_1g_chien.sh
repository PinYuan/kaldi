...
dir=exp/chain${nnet3_affix}/pretrain_80d/tdnn_${affix}_chien/e${num_of_epoch}
train_data_dir=my_data/denoised_noisy/chien/${train_set}_sp_hires # data/${train_set}_sp_hires
    ...
    (
      ...
      for lmtype in tgpr_5k tgpr; do
        steps/nnet3/decode.sh \
          ...
          $tree_dir/graph_${lmtype} my_data/denoised_noisy/chien/${data}_hires ${dir}/decode_${lmtype}_${data_affix} || exit 1
      done

      steps/lmrescore.sh \
        --self-loop-scale 1.0 \
        --cmd "$decode_cmd" data/lang_test_{tgpr,tg} \
        my_data/denoised_noisy/chien/${data}_hires ${dir}/decode_{tgpr,tg}_${data_affix} || exit 1

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_feam_specaug_fbank_v0/${argu_desc}
train_data_dir=data/${train_set}_sp_hires
train_ivector_dir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires
lores_train_data_dir=data/${train_set}_sp

target_scp=data/${target_set}_sp_fbank/feats.target.scp

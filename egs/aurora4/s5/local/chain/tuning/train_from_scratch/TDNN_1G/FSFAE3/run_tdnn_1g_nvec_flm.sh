...
# test_sets=""
test_sets="test_A test_B test_C test_D test_eval92"
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_nvec/flm/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn1 input=lda $tdnn_opts dim=1024

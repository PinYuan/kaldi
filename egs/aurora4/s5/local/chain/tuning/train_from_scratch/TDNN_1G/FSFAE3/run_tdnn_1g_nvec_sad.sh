...
conf_threshold=0.8
argu_desc="e${num_of_epoch}_ct${conf_threshold}_il${initial_effective_lrate}_fl${final_effective_lrate}"
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_nvec/sad/${argu_desc}

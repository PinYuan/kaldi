...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE1/tdnn_${affix}_feam_baseline_mfcc_v1/e${num_of_epoch}
...
if [ $stage -le 15 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn6 input=Append(lda,prefinal-ae@-1,prefinal-ae@0,prefinal-ae@1) $tdnn_opts dim=1024

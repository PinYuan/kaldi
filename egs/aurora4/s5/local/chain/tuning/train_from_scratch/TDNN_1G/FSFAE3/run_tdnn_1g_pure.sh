...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_pure/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  fixed-affine-layer name=lda input=Append(input@-1,input@0,input@1) affine-transform-file=$dir/configs/lda.mat

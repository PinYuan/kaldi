...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_nvec/sad_feam_specaug_mfcc_v1/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn6 input=Append(lda,prefinal-ae@-1,prefinal-ae,prefinal-ae@1) $tdnn_opts dim=1024

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/tdnn_${affix}_nvec/flm_feam_specaug_mfcc_v0/${argu_desc}
train_data_dir=data/${train_set}_sp_hires
train_ivector_dir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires
train_nvector_dir=my_data/noise_vector/flm/nvectors_${train_set}_sp_hires
...
if [ $stage -le 15 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn6 input=Append(lda,tdnn5) $tdnn_opts dim=1024
...
if [ $stage -le 16 ]; then
  ...
  steps/chain/train_dcae.py --stage=$train_stage \
    --cmd="$decode_cmd" \
    --feat.online-ivector-dir=$train_nvector_dir \
    ...
    (
      ...
      for lmtype in tgpr_5k; do
        steps/nnet3/decode.sh \
          ...
          --hack-nvector true \
          --online-ivector-dir my_data/noise_vector/flm/nvectors_${data}_hires \

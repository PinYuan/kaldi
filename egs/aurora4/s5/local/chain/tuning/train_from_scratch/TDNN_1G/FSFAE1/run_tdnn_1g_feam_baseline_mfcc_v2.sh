...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE1/tdnn_${affix}_feam_baseline_mfcc_v2/e${num_of_epoch}
...
if [ $stage -le 15 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn6 input=Append(lda,prefinal-ae) $tdnn_opts dim=1024

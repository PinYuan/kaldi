...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G/FSFAE3/AM_SPECAUG/tdnn_${affix}_pure_feam_specaug_mfcc_v0/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  fixed-affine-layer name=lda input=Append(spec-augment@-1,spec-augment@0,spec-augment@1) affine-transform-file=$dir/configs/lda.mat

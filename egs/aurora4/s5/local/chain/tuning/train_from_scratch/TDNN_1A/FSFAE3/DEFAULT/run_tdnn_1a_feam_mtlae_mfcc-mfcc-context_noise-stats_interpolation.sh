...
argu_desc="e${num_of_epoch}_fdae${frame_weight_dae}_fdspae${frame_weight_dspae}_stats-900.1.1.900_scale0.5-0.25-0.25-0.33_il${initial_effective_lrate}_fl${final_effective_lrate}"
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mtlae_mfcc-mfcc-context_noise-stats_interpolation/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(Scale(0.5, context-dae), Scale(0.25, stats-dspae), Scale(0.25, delta), Scale(0.33, ReplaceIndex(ivector, t, 0)))

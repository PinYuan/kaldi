...
local/nnet3/run_ivector_common_feam.sh \
  --stage $stage --nj $nj \
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mltae-context_mfcc-mfcc-context/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  relu-renorm-layer name=tdnn2-dae dim=256 input=Append(tdnn1@-1, tdnn1@2)
  relu-renorm-layer name=tdnn2-shared dim=768 input=Append(tdnn1@-1, tdnn1@2)
  relu-renorm-layer name=tdnn2-dspae dim=256 input=Append(tdnn1@-1, tdnn1@2)

  relu-renorm-layer name=tdnn3-dae dim=512 input=Append(tdnn2-dae@-3, tdnn2-dae@3, tdnn2-shared@-3, tdnn2-shared@3)
  relu-renorm-layer name=tdnn3-shared dim=512 input=Append(tdnn2-dae@-3, tdnn2-dae@3, tdnn2-shared@-3, tdnn2-shared@3, tdnn2-dspae@-3, tdnn2-dspae@3)
  relu-renorm-layer name=tdnn3-dspae dim=512 input=Append(tdnn2-shared@-3, tdnn2-shared@3, tdnn2-dspae@-3, tdnn2-dspae@3)

  relu-renorm-layer name=tdnn4-dae dim=768 input=Append(tdnn3-dae@-7, tdnn3-dae@2, tdnn3-shared@-7, tdnn3-shared@2)
  relu-renorm-layer name=tdnn4-shared dim=256 input=Append(tdnn3-dae@-7, tdnn3-dae@2, tdnn3-shared@-7, tdnn3-shared@2, tdnn3-dspae@-7, tdnn3-dspae@2)
  relu-renorm-layer name=tdnn4-dspae dim=768 input=Append(tdnn3-shared@-7, tdnn3-shared@2, tdnn3-dspae@-7, tdnn3-dspae@2)

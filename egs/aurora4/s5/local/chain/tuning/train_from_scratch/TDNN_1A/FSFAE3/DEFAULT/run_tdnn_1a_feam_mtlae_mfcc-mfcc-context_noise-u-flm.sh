...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mtlae_mfcc-mfcc-context_noise-u-flm/${argu_desc}
train_data_dir=data/${train_set}_sp_hires
train_ivector_dir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp_hires
train_nivector_dir=my_data/ni_vector/flm/nivectors_${train_set}_sp_hires
    ...
    (
      ...
      for lmtype in tgpr_5k bg; do
        steps/nnet3/decode.sh \
          ...
          --hack-nvector true \
          --online-ivector-dir my_data/ni_vector/flm/nivectors_${data}_hires \

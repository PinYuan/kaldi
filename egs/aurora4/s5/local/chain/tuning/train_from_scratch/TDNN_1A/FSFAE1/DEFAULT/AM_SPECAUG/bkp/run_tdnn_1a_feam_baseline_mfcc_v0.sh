...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE1/DEFAULT/AM_SPECAUG/tdnn_1a_feam_baseline_mfcc_v0/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(tdnn5, delta, Scale(1.0, ReplaceIndex(ivector, t, 0)))

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE1/DEFAULT/tdnn_1a_feam_baseline_mfcc_v3/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(prefinal-ae@-3,prefinal-ae@0,prefinal-ae@3, delta, Scale(1.0, ReplaceIndex(ivector, t, 0)))
...
if [ $stage -le 13 ]; then
  ...
  steps/chain/train_dcae.py --stage=11 \
    --cmd="$train_cmd" \

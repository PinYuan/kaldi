...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/AM_SPECAUG/tdnn_${affix}_l17-d1224-b160/e${num_of_epoch}
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 $tdnn_opts dim=1224 input=input2

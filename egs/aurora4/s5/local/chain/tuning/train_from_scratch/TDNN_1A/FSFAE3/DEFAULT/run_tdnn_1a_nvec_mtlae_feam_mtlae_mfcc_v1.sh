...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_nvec/mtlae_feam_mtlae_mfcc_v1/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(prefinal-dae@-1,prefinal-dae@0,prefinal-dae@1, delta, prefinal-dspae)

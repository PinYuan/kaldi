...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_${affix}_pure/e${num_of_epoch}
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 $tdnn_opts dim=1024 input=delta

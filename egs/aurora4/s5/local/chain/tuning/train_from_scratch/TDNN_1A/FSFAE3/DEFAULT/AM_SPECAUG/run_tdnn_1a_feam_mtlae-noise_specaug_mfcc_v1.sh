...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/AM_SPECAUG/tdnn_1a_feam_mtlae-noise_specaug_mfcc_v1/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(prefinal-dspae@-1,prefinal-dspae@0,prefinal-dspae@1, delta, Scale(1.0, ReplaceIndex(ivector, t, 0)))

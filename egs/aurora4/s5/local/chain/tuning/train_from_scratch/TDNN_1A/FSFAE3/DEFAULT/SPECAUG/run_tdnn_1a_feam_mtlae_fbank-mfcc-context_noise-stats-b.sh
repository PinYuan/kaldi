...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/SPECAUG/tdnn_1a_feam_mtlae_fbank-mfcc-context_noise-stats-b/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=context-dae input=Append(dae-batchnorm@-1, dae-batchnorm@0, dae-batchnorm@1)

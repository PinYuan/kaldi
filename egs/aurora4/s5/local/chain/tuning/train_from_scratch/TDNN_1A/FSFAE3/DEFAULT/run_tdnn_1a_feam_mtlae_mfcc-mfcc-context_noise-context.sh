...
remove_egs=false
num_of_epoch=20
frame_weight_dae=0.3
frame_weight_dspae=0.3
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mtlae_mfcc-mfcc-context_noise-context/${argu_desc}

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_mtlae_mfcc-mfcc-context_nonoisy/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(context-dae, Scale(1.0, ReplaceIndex(ivector, t, 0)))

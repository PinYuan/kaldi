...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/AM_SPECAUG/tdnn_1a_feam_mtlae_mfcc-mfcc-context_noise-stats/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(prefinal-dae@-1,prefinal-dae@0,prefinal-dae@1, dspae-stats, delta, Scale(1.0, ReplaceIndex(ivector, t, 0)))

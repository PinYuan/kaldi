...
frame_subsampling_factor_dae=1
frame_subsampling_factor_dspae=1
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE1/DEFAULT/tdnn_1a_feam_mtlae_mfcc-mfcc-context/${argu_desc}
...
if [ $stage -le 13 ]; then
  ...
  steps/chain/train_mtlae.py --stage=15 \
    --cmd="$train_cmd" \
    ...
    --egs.frame-subsampling-factor-dae=$frame_subsampling_factor_dae \
    --egs.frame-subsampling-factor-dspae=$frame_subsampling_factor_dspae \

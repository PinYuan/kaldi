...
argu_desc="e${num_of_epoch}_f${frame_weight}_s0.0-1.0_il${initial_effective_lrate}_fl${final_effective_lrate}"
...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_1a_feam_tdnn_mfcc-mfcc-context_si/${argu_desc}
...
if [ $stage -le 12 ]; then
  ...
  no-op-component name=input2 input=Append(Sum(Scale(0.0, context-dae), Scale(1.0, delta)), Scale(1.0, ReplaceIndex(ivector, t, 0)))

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G_MY/FSFAE3/tdnn_${affix}_feam_baseline_mfcc_v2/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  affine-layer name=affine input=Append(prefinal-ae,input@-1,input@0,input@1,ReplaceIndex(ivector, t, 0))

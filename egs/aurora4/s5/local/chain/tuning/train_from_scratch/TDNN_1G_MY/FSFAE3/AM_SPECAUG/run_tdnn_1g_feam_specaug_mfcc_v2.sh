...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G_MY/FSFAE3/AM_SPECAUG/tdnn_${affix}_feam_specaug_mfcc_v2/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  affine-layer name=affine input=Append(prefinal-ae,spec-augment@-1,spec-augment@0,spec-augment@1,ReplaceIndex(ivector, t, 0))

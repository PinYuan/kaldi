...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G_MY/FSFAE3/AM_SPECAUG/tdnn_${affix}_feam_specaug_mfcc_v0/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  affine-layer name=affine input=Append(tdnn5,spec-augment@-1,spec-augment@0,spec-augment@1,ReplaceIndex(ivector, t, 0))

  # the first splicing is moved before the lda layer, so no splicing here
  relu-batchnorm-dropout-layer name=tdnn6 input=affine $tdnn_opts dim=1024

...
dir=exp/chain${nnet3_affix}/train_from_scratch/TDNN_1G_MY/FSFAE3/AM_SPECAUG/tdnn_${affix}_feam_specaug_mfcc_v1/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  affine-layer name=affine input=Append(prefinal-ae@-1,prefinal-ae@0,prefinal-ae@1,spec-augment@-1,spec-augment@0,spec-augment@1,ReplaceIndex(ivector, t, 0))

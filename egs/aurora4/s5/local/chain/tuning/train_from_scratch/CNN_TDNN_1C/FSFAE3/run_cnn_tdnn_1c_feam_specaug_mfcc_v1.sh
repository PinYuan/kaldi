...
dir=exp/chain${nnet3_affix}/train_from_scratch/CNN_TDNN_1C/FSFAE3/cnn_tdnn_${affix}_feam_specaug_mfcc_v1/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(idct-batchnorm, ivector-batchnorm, prefinal-ae) num-filters1=1 num-filters2=5 num-filters3=1 height=40

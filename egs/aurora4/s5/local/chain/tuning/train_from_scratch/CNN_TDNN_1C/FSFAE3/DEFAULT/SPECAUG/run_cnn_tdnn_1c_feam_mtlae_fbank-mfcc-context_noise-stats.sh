...
if [ $stage -le 15 ]; then
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(spec-augment, ivector-batchnorm, context-dae, stats-dspae) num-filters1=1 num-filters2=5 num-filters3=3 num-filters4=2 height=40

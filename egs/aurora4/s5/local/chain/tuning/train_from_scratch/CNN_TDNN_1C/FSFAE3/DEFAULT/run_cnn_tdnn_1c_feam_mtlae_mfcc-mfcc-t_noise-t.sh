...
dir=exp/chain${nnet3_affix}/train_from_scratch/CNN_TDNN_1C/FSFAE3/DEFAULT/feam_mtlae_mfcc-mfcc-t_noise-t/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(idct-batchnorm, ivector-batchnorm, info-dae-dspae) num-filters1=1 num-filters2=5 num-filters3=2 height=40

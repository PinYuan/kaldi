...
dir=exp/chain${nnet3_affix}/train_from_scratch/FSFAE3/cnn_tdnn_${affix}_feam_baseline/${argu_desc}
...
if [ $stage -le 15 ]; then
  ...
  relu-renorm-layer name=tdnn5 dim=1000
  ...
  combine-feature-maps-layer name=combine_inputs input=Append(idct-batchnorm, ivector-batchnorm, tdnn5) num-filters1=1 num-filters2=5 num-filters3=25 height=40

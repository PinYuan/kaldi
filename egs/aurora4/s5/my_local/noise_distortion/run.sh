...
# Extract 40-D MFCC
data_dirs="train_si84_noise_mismatch_sp_hires"
data_dirs="test_A_noise_mismatch_hires test_B_noise_mismatch_hires test_C_noise_mismatch_hires test_D_noise_mismatch_hires"

...
dir=exp/chain${nnet3_affix}/train_from_scratch/CNN_TDNN_1A/FSFAE3/DEFAULT/SPECAUG/feam_mtlae_fbank-mfcc-t/${argu_desc}
...
if [ $stage -le 13 ]; then
  ...
  no-op-component name=info-dae input=Append(prefinal-dae)
  batchnorm-component name=info-dae-batchnorm input=info-dae
  combine-feature-maps-layer name=combine_inputs input=Append(spec-augment, ivector-batchnorm, info-dae-batchnorm) num-filters1=1 num-filters2=5 num-filters3=1 height=40

...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/MIXUP/SPECAUG/tdnn_1a_feam_mtlae_fbank-mfcc-context_noise-context/${argu_desc}
...
if [ $stage -le 16 ]; then
  ...
  steps/nnet3/chain/train_mixup.py --stage 326 \
    --cmd "$decode_cmd" \

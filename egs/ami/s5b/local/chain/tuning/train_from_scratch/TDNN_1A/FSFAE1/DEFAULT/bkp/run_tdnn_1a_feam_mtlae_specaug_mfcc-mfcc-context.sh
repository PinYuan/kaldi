...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE1/DEFAULT/tdnn_${tdnn_affix}_sp_bi_ihmali/feam_mtlae_specuag_mfcc_v1/${argu_desc}
...
if [ $stage -le 16 ]; then
  ...
  steps/chain/train_mtlae.py --stage 90 \
    --cmd "$decode_cmd" \

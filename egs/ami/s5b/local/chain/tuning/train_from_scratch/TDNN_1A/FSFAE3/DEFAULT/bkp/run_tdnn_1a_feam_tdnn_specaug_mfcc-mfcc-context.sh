...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/train_from_scratch/TDNN_1A/FSFAE3/DEFAULT/tdnn_${tdnn_affix}_sp_bi_ihmali/feam_baseline_specaug_mfcc-mfcc-context/${argu_desc}

...
affix=_l6_r75   #affix for TDNN+LSTM directory e.g. "1a" or "1b", in case we change the configuration.
common_egs_dir=
reporting_email=
...
if [ $stage -le 15 ]; then
  ...
  tdnnf-layer name=tdnnf14 l2-regularize=0.01 dropout-proportion=0.0 bypass-scale=0 input=tdnnf12 dim=768 bottleneck-dim=128 time-stride=3

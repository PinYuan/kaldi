...
affix=_l3_U_neg   #affix for TDNN+LSTM directory e.g. "1a" or "1b", in case we change the configuration.
common_egs_dir=
reporting_email=
...
if [ $stage -le 15 ]; then
  ...
  tdnnf-layer name=tdnnf14 $tdnnf_opts input=tdnnf12 dim=1024 bottleneck-dim=128 time-stride=3
